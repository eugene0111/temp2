...
export default function RecruitmentForm({ positions }) {
    ...
    return (
      <div className="bg-darker/50 p-12 rounded-2xl border border-neon-green/30 text-center backdrop-blur-sm">
        ...
        <button
          ...
          className="mt-8 text-sm font-bold uppercase tracking-widest text-neon-green hover:text-white transition-colors"
        >
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <input
            ...
            className="bg-darkest border border-white/10 rounded-lg px-4 py-3 text-white w-full outline-none focus:border-neon-green transition-all"
            required
          />
          <input
            name="email"
